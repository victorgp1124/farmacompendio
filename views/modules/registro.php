    ...
    <div class="container">
      <form class="form-login" method="post">
        ...
        <div class="login-wrap">
          <input type="text" class="form-control" name="correoR" placeholder="Correo" autofocus>
          <br>
          <input type="text" class="form-control" name="nombreR" placeholder="Usuario" autofocus>
          <br>
          <input type="password" class="form-control" name="passR" placeholder="Contraseña">
          <br>
